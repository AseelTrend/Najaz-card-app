...
$targetBase = 'https://api.oranosmarket.com';

// اسم المجلد الذي وضعت فيه هذا الملف على استضافتك
// (إذا وضعت الملف في public_html/oranosmarket/ اتركه كما هو)
$proxyFolder = '/oranosmarket/';
